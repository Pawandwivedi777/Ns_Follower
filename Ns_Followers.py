...
class Ns_Followers:
    def __init__(self):
        ...
        self.__username='pawanfast71' #Enter UserName Here
        self._session='66977138016%3AVxIi2XMnSC9GYs%3A20%3AAYfSnlYuORKku9fo0zKRo5TuoLipdGPg2sLn6n2F0g' #Enter SessionID Here
